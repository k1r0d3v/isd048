...
public class ClientReservationDto {
    ...
    public ClientReservationDto(Long id, long showId, String email, String creditCard, int tickets, boolean isValid, String code, Calendar reservationDate, float price) {
        this.id = id;
        this.showId = showId;
        this.email = email;
